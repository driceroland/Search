...
- Apple Passwords support: import directly from Apple Passwords exports, and connect to Apple Passwords / iCloud Keychain with the iCloud Passwords extension to autofill and save credentials in sync with the Passwords app. ([#17](https://github.com/driceroland/Search/issues/17))
